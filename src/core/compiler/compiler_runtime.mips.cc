/**
 * @file compiler_runtime.mips.cc
 * @brief MIPS 32-bit (o32) Compiler Runtime Support
 *
 * @details Provides 64-bit division, modulo, and shift operations for 32-bit
 * MIPS (o32). These functions are called implicitly by the compiler when
 * building with -nostdlib, as MIPS32 cannot perform 64-bit division/modulo in
 * hardware (it has a mult/multu for 32x32->64 multiply, but no 64-bit divide).
 * MIPS32 rel2 does have hardware clz/clo, so __builtin_clzll/__builtin_ctzll
 * compile to native instructions (no compiler_builtins.h override needed).
 *
 * Ported from compiler_runtime.riscv32.cc (portable binary long-division —
 * only the arch #if guard differs).
 *
...
{
	// =========================================================================
	// MIPS 32: 64-bit Unsigned Division Functions
	// =========================================================================
	 ...
	 *
	 * Called by compiler for: uint64_t_a / uint64_t_b (on 32-bit MIPS)
	 */
	...
	// =========================================================================
	// MIPS 32: 64-bit Signed Division Helper
	// =========================================================================
	...
	// =========================================================================
	// MIPS 32: 64-bit Signed Division Functions
	// =========================================================================

	/**
	 * __divdi3 - Signed 64-bit division
	 *
	 * Called by compiler for: int64_t_a / int64_t_b (on 32-bit MIPS)
	 */
	...
	// =========================================================================
	// MIPS 32: 64-bit Shift Functions
	// =========================================================================

	/**
	 * __lshrdi3 - 64-bit logical shift right
	 *
	 * Called by compiler for: uint64_t_a >> shift_amount (on 32-bit MIPS)
	 *
	 ...
	 *
	 * Called by compiler for: int64_t_a << shift_amount (on 32-bit MIPS)
	 *
	 * Behavior: Shift amounts >= 64 or < 0 return 0.
	 */
	...
	// =========================================================================
	// MIPS 32: Floating-Point Conversion Functions
	// =========================================================================

	/**
	 * __floatdidf - Convert signed 64-bit integer to double
	 *
	 * Called by compiler for: (double)int64_value (on 32-bit MIPS)
	 *
	 ...
	 *
	 * Called by compiler for: (double)uint64_value (on 32-bit MIPS)
	 */
	 ...
	 *
	 * Called by compiler for: (int64_t)double_value (on 32-bit MIPS)
	 */
	 ...
	 *
	 * Called by compiler for: (uint64_t)double_value (on 32-bit MIPS)
	 */
